...
const ProfileId = ({ match, getProfileById, createProfile, employee: { employee, loading }, history }) => {
    ...
    useEffect(() => {
        ...
        setFormData({
            employeeId: loading || !employee.employeeName ? '' : employee.employeeId,
            employeeName: loading || !employee.employeeName ? '' : employee.employeeName,
            employeeStatus: loading || !employee.employeeStatus ? '' : employee.employeeStatus,
            employeeAddress: loading || !employee.employeeAddress ? '' : employee.employeeAddress,
            employeeSalary: loading || !employee.employeeSalary ? '' : employee.employeeSalary,
            employeeTax: loading || !employee.employeeTax ? '' : employee.employeeTax,
            employeeHra: loading || !employee.employeeHra ? '' : employee.employeeHra,
            employee401k: loading || !employee.employee401k ? '' : employee.employee401k
...
export default connect(mapStateToProps, { getProfileById, createProfile })(ProfileId)
